...
const routes = [
    ...
    {path: '/email-verification', name: "email-verify", component: EmailVerify, meta: {middleware: ["auth", "activeUser"], layout: "guest"}},
    {path: '/restore-profile', name: "restore-profile", component: RestoreProfile, meta: {middleware: ["auth", "inactiveUser"], layout: "guest"}},
